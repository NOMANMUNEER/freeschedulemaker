...
export interface ScheduleTemplate {
  ...
  settings?: Partial<import('../types/schedule').ScheduleSettings>;
}

export const SCHEDULE_TEMPLATES: ScheduleTemplate[] = [
  {
    id: 'wedding-4pm-first-look', name: '4 PM Ceremony — First Look', description: 'A full wedding day timeline with portraits before the ceremony.', variant: 'wedding', settings: { visibleDays: ['Saturday'], startHour: 6, endHour: 24, lineSpacing: 15, clockType: '12-Hour', activeWeek: 'Wedding Day' }, events: [
      { title: 'Hair and makeup begins', days: ['Saturday'], startTime: '08:00', endTime: '10:30', color: '#be185d', category: 'Getting Ready' }, { title: 'Photographer and videographer arrive, detail shots', days: ['Saturday'], startTime: '10:30', endTime: '12:00', color: '#7c3aed', category: 'Photos' }, { title: 'Lunch for the wedding party', days: ['Saturday'], startTime: '12:00', endTime: '13:00', color: '#b45309', category: 'Getting Ready' }, { title: 'Get dressed', days: ['Saturday'], startTime: '13:00', endTime: '14:00', color: '#be185d', category: 'Getting Ready' }, { title: 'First look', days: ['Saturday'], startTime: '14:00', endTime: '14:20', color: '#7c3aed', category: 'Photos' }, { title: 'Couple portraits', days: ['Saturday'], startTime: '14:20', endTime: '14:50', color: '#7c3aed', category: 'Photos' }, { title: 'Wedding party portraits', days: ['Saturday'], startTime: '14:50', endTime: '15:15', color: '#7c3aed', category: 'Photos' }, { title: 'Family formals', days: ['Saturday'], startTime: '15:15', endTime: '15:30', color: '#7c3aed', category: 'Photos' }, { title: 'Guests arrive and are seated', days: ['Saturday'], startTime: '15:30', endTime: '16:00', color: '#0f766e', category: 'Ceremony' }, { title: 'Ceremony', days: ['Saturday'], startTime: '16:00', endTime: '16:30', color: '#0f766e', category: 'Ceremony' }, { title: 'Cocktail hour', days: ['Saturday'], startTime: '16:30', endTime: '17:30', color: '#0369a1', category: 'Cocktail Hour' }, { title: 'Grand entrance', days: ['Saturday'], startTime: '17:30', endTime: '17:45', color: '#9a3412', category: 'Reception' }, { title: 'Dinner', days: ['Saturday'], startTime: '17:45', endTime: '18:45', color: '#9a3412', category: 'Reception' }, { title: 'Toasts', days: ['Saturday'], startTime: '18:45', endTime: '19:15', color: '#9a3412', category: 'Reception' }, { title: 'First dance and parent dances', days: ['Saturday'], startTime: '19:15', endTime: '19:45', color: '#9a3412', category: 'Reception' }, { title: 'Cake cutting', days: ['Saturday'], startTime: '19:45', endTime: '20:00', color: '#9a3412', category: 'Reception' }, { title: 'Open dancing', days: ['Saturday'], startTime: '20:00', endTime: '22:00', color: '#9a3412', category: 'Reception' }, { title: 'Last dance and send-off', days: ['Saturday'], startTime: '22:00', endTime: '22:30', color: '#9a3412', category: 'Reception' },
    ]
  },
  { id: 'wedding-4pm-no-first-look', name: '4 PM Ceremony — No First Look', description: 'Keeps portraits after the ceremony and allows a longer cocktail hour.', variant: 'wedding', settings: { visibleDays: ['Saturday'], startHour: 6, endHour: 24, lineSpacing: 15, clockType: '12-Hour', activeWeek: 'Wedding Day' }, events: [{ title: 'Hair and makeup begins', days: ['Saturday'], startTime: '08:30', endTime: '11:30', color: '#be185d' }, { title: 'Vendor arrivals and detail shots', days: ['Saturday'], startTime: '11:30', endTime: '12:30', color: '#7c3aed' }, { title: 'Get dressed', days: ['Saturday'], startTime: '13:30', endTime: '14:30', color: '#be185d' }, { title: 'Guests arrive', days: ['Saturday'], startTime: '15:30', endTime: '16:00', color: '#0f766e' }, { title: 'Ceremony', days: ['Saturday'], startTime: '16:00', endTime: '16:30', color: '#0f766e' }, { title: 'Family and couple portraits', days: ['Saturday'], startTime: '16:30', endTime: '17:30', color: '#7c3aed' }, { title: 'Cocktail hour', days: ['Saturday'], startTime: '16:30', endTime: '18:00', color: '#0369a1' }, { title: 'Grand entrance and dinner', days: ['Saturday'], startTime: '18:00', endTime: '19:15', color: '#9a3412' }, { title: 'Toasts and dances', days: ['Saturday'], startTime: '19:15', endTime: '20:00', color: '#9a3412' }, { title: 'Open dancing and send-off', days: ['Saturday'], startTime: '20:00', endTime: '22:30', color: '#9a3412' }] },
  { id: 'wedding-2pm', name: '2 PM Ceremony', description: 'An earlier ceremony with daylight portraits and an early reception.', variant: 'wedding', settings: { visibleDays: ['Saturday'], startHour: 6, endHour: 24, lineSpacing: 15, clockType: '12-Hour', activeWeek: 'Wedding Day' }, events: [{ title: 'Hair and makeup begins', days: ['Saturday'], startTime: '06:30', endTime: '09:30', color: '#be185d' }, { title: 'Details and getting dressed', days: ['Saturday'], startTime: '10:00', endTime: '11:30', color: '#7c3aed' }, { title: 'First look and portraits', days: ['Saturday'], startTime: '11:30', endTime: '13:15', color: '#7c3aed' }, { title: 'Guests arrive', days: ['Saturday'], startTime: '13:30', endTime: '14:00', color: '#0f766e' }, { title: 'Ceremony', days: ['Saturday'], startTime: '14:00', endTime: '14:30', color: '#0f766e' }, { title: 'Cocktail hour', days: ['Saturday'], startTime: '14:30', endTime: '15:30', color: '#0369a1' }, { title: 'Dinner and toasts', days: ['Saturday'], startTime: '15:45', endTime: '17:00', color: '#9a3412' }, { title: 'Dances and open floor', days: ['Saturday'], startTime: '17:00', endTime: '20:30', color: '#9a3412' }, { title: 'Send-off', days: ['Saturday'], startTime: '20:30', endTime: '21:00', color: '#9a3412' }] },
  { id: 'wedding-5pm', name: '5 PM Ceremony', description: 'A later ceremony with an evening-forward reception timeline.', variant: 'wedding', settings: { visibleDays: ['Saturday'], startHour: 6, endHour: 24, lineSpacing: 15, clockType: '12-Hour', activeWeek: 'Wedding Day' }, events: [{ title: 'Hair and makeup begins', days: ['Saturday'], startTime: '09:00', endTime: '12:00', color: '#be185d' }, { title: 'Details and lunch', days: ['Saturday'], startTime: '12:00', endTime: '13:00', color: '#7c3aed' }, { title: 'Get dressed and first look', days: ['Saturday'], startTime: '13:30', endTime: '14:30', color: '#be185d' }, { title: 'Portraits and family formals', days: ['Saturday'], startTime: '14:30', endTime: '16:15', color: '#7c3aed' }, { title: 'Guests arrive', days: ['Saturday'], startTime: '16:30', endTime: '17:00', color: '#0f766e' }, { title: 'Ceremony', days: ['Saturday'], startTime: '17:00', endTime: '17:30', color: '#0f766e' }, { title: 'Cocktail hour', days: ['Saturday'], startTime: '17:30', endTime: '18:30', color: '#0369a1' }, { title: 'Dinner and toasts', days: ['Saturday'], startTime: '18:45', endTime: '20:00', color: '#9a3412' }, { title: 'Dances and cake', days: ['Saturday'], startTime: '20:00', endTime: '21:00', color: '#9a3412' }, { title: 'Open dancing and send-off', days: ['Saturday'], startTime: '21:00', endTime: '23:30', color: '#9a3412' }] },
