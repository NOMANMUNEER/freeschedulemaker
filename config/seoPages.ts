...
export const SEO_PAGES: Record<BuilderVariantId, SEOPageData> = {
  default: {
    ...
    faqHeading: 'Your Free Schedule Maker - No Sign-Up',
  ...
  employee: {
    variantId: 'employee',
    metaTitle: 'Employee Schedule Maker Online | Free Work Schedule Creator',
    metaDescription: 'Use this employee schedule maker to create work schedules, staff rosters, shift plans, departments, and weekly team coverage online for free.',
    keywords: 'employee schedule maker, employee schedule creator, employee work schedule maker, employee schedule builder, free employee schedule maker, team schedule maker',
    canonicalPath: '/employee-schedule-creator',
    heroBadge: 'Free Employee Schedule Maker',
    heroHeading: 'Employee Schedule Maker',
    heroSubheading: 'Create employee work schedules online. Assign staff shifts, roles, departments, locations, and weekly coverage, then download a ready-to-share schedule.',
    featuresHeading: 'Create Employee Work Schedules Online',
    featuresIntroduction: 'Align staff shifts, specify work locations, assign jobs, and reduce work schedule confusion with a clear visual employee schedule.',
