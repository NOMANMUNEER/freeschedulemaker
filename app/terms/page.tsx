...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://freeschedulemaker.com/terms',
  },
  openGraph: {
    title: 'Terms of Service | FreeScheduleMaker',
    description: 'Terms of Service and Conditions for using FreeScheduleMaker.',
    url: 'https://freeschedulemaker.com/terms',
    type: 'website',
  },
};
    ...
    <main className="min-h-screen bg-slate-50 py-20 px-6">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200 text-slate-800">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed">
          ...
          <p>Welcome to ScheduleBuilder Online. By accessing this website, we assume you accept these terms and conditions. Do not continue to use ScheduleBuilder Online if you do not agree to take all of the terms and conditions stated on this page.</p>

          <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">1. License and Use of Service</h2>
          <p>ScheduleBuilder Online grants you a non-exclusive, non-transferable, limited right to access and use our free online schedule maker for personal, academic, or internal business purposes. You may generate, download, and share your exported schedules.</p>
          ...
          <p>This website is provided "as is," with all faults, and ScheduleBuilder Online expresses no representations or warranties, of any kind related to this website or the materials contained on this website. While we strive to ensure the tool works perfectly across all devices, we do not guarantee uninterrupted access.</p>

          <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">4. Limitation of Liability</h2>
          <p>In no event shall ScheduleBuilder Online, nor any of its officers, directors, and employees, be held liable for anything arising out of or in any way connected with your use of this website.</p>
