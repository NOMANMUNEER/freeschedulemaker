...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://freeschedulemaker.com/privacy-policy',
  },
  openGraph: {
    title: 'Privacy Policy | FreeScheduleMaker',
    description: 'Privacy Policy for FreeScheduleMaker.',
    url: 'https://freeschedulemaker.com/privacy-policy',
    type: 'website',
  },
};
    ...
    <div className="min-h-screen bg-slate-50 py-20 px-6">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200 text-slate-800">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed">
          ...
          <p>At ScheduleBuilder Online, accessible from our website, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by ScheduleBuilder Online and how we use it.</p>

          <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">Log Files</h2>
          <p>ScheduleBuilder Online follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks.</p>

          <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">Cookies and Web Beacons</h2>
          <p>Like any other website, ScheduleBuilder Online uses "cookies". These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on ScheduleBuilder Online, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>
          <p>Note that ScheduleBuilder Online has no access to or control over these cookies that are used by third-party advertisers.</p>
