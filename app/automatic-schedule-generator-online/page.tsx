...
export const metadata: Metadata = {
  title: 'Automatic Schedule Generator Online | Free Auto Maker',
  description: 'Instantly build your perfect timetable with our automatic schedule generator online. Easy, fast, and completely free to use.',
  keywords: 'automatic schedule generator online, free automatic schedule generator online, auto schedule maker, automatic timetable creator, schedule builder online',
  alternates: {
    canonical: 'https://freeschedulemaker.com/automatic-schedule-generator-online',
  },
  openGraph: {
    title: 'Automatic Schedule Generator Online | Free Auto Maker',
    description: 'Instantly build your perfect timetable with our automatic schedule generator online. Easy, fast, and completely free to use.',
    type: 'website',
    url: 'https://freeschedulemaker.com/automatic-schedule-generator-online',
    images: ['/og-image.png'],
  }
};
      ...
      <header className="bg-white border-b border-slate-200 pt-24 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 text-indigo-700 font-bold text-sm mb-6 border border-indigo-100 shadow-sm">
            ...
            #1 Fast Schedule Builder
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-6 leading-tight">
            Automatic Schedule Generator Online
          </h1>
          <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Stop wasting time drawing tables by hand. Get your week organized in seconds using our fast and <strong>automatic schedule generator online</strong>. Beautiful results, zero effort, 100% free.
          </p>
          ...
          <div className="flex items-center justify-center gap-6 text-sm font-medium text-slate-500">
            <span className="flex items-center gap-1.5"><CheckCircle className="h-4 w-4 text-emerald-500" /> No downloads required</span>
            <span className="flex items-center gap-1.5"><CheckCircle className="h-4 w-4 text-emerald-500" /> Free to use instantly</span>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              'Instant Timetable Builder', 
              'Smart Calendar Maker'
            ].map((tag) => (
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">How to Generate Your Schedule Automatically</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">Our tool automatically formats and arranges your events. Follow these quick steps to get a perfect looking schedule.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 relative pt-12">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">1. Select Format</h3>
              <p className="text-slate-600 leading-relaxed">Choose whether you want a 5-day work week or a 7-day calendar, and the generator automatically builds the grid for you.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 relative pt-12">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">2. Insert Details</h3>
              <p className="text-slate-600 leading-relaxed">Quickly add your classes, meetings, or shifts. The system automatically sizes and positions the blocks based on the time intervals you input.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 relative pt-12">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">3. Auto-Color Code</h3>
              <p className="text-slate-600 leading-relaxed">Pick from preset beautiful color palettes that automatically apply complementary text colors, ensuring your schedule is perfectly readable.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 relative pt-12">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">4. Instant Export</h3>
              <p className="text-slate-600 leading-relaxed">Hit export and the generator instantly compiles your grid into a high-resolution image file ready for printing or digital sharing.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white border-y border-slate-200">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Why Use An Automatic Schedule Generator?</h2>
          ...
          <div className="w-full lg:w-1/3 bg-slate-50 p-8 rounded-2xl border border-slate-200 shadow-sm relative">
            ...
            <div className="relative z-10 pt-6">
              ...
              <p className="text-slate-700 italic mb-6 leading-relaxed">
                I was trying to make my college schedule in Word and got so frustrated. I searched for an automatic schedule generator online, found this, and finished it in 3 minutes.
              </p>
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-indigo-100 rounded-full flex items-center justify-center font-bold text-indigo-700">DP</div>
                <div>
                  <p className="font-bold text-slate-900 text-sm">David P.</p>
                  <p className="text-slate-500 text-xs">College Freshman</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Auto Generator FAQ</h2>
            <p className="text-slate-600">Answers to the most common questions about our tool.</p>
          </div>

          <div className="space-y-4">
            {[
              {
                q: "What makes this generator automatic?",
                a: "Unlike drawing tools or spreadsheets where you have to manually merge cells and calculate heights, our app automatically positions and sizes your event blocks based purely on the start and end times you enter."
              },
              {
                q: "Is this automatic schedule generator free to use?",
                a: "Yes, 100% free. We don't hide features behind paywalls or require a credit card."
              },
              {
                q: "Do I have to download software?",
                a: "No! The entire generation process happens online inside your web browser. Just open the page and start building."
              },
              {
                q: "How do I print the schedule once generated?",
                a: "Click the 'Export' button to save it as an image file to your computer. You can then open the image and print it using your standard printer settings."
              }
            ].map((faq, i) => (
          ...
          <div className="mt-12 text-center">
            ...
            >
              Start Generating Automatically <Zap className="h-5 w-5" />
            </Link>
          </div>
        </div>
      </section>
